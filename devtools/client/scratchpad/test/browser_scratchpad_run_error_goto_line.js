...
function test() {
  ...
  BrowserTestUtils.loadURI(
    gBrowser,
    "data:text/html;charset=utf8,test Scratchpad pretty print."
  );
}
...
function runTests(sw) {
  ...
  sp.run()
    .then(
      () => {
        ...
        is(
          inputLine,
          errorLine,
          "jumpToLine input field is set from editor selection"
        );
    ...
    .then(
      () => {
        var statusBarField = sp.editor.container.ownerDocument.querySelector(
          "#statusbar-line-col"
        );
