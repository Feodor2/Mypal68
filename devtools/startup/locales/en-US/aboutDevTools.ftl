...
enable-title = Enable Mypal Developer Tools
enable-inspect-element-title = Enable Mypal Developer Tools to use Inspect Element
enable-inspect-element-message = Examine and edit HTML and CSS with the Developer Tools’ Inspector.
enable-about-debugging-message = Develop and debug WebExtensions, web workers, service workers and more with Mypal Developer Tools.
...
enable-common-message = Mypal Developer Tools are disabled by default to give you more control over your browser.
...
welcome-title = Welcome to Mypal Developer Tools!
...
footer-title = Mypal Developer Edition
footer-message = Looking for more than just Developer Tools? Check out the Mypal browser that is built specifically for developers and modern workflows.
