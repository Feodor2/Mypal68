...
function run_test() {
  ...
  let principal2 = Services.scriptSecurityManager.createCodebasePrincipalFromOrigin(
    "http://google.com:2048"
  );
  let principal3 = Services.scriptSecurityManager.createCodebasePrincipalFromOrigin(
    "https://google.com"
  );
