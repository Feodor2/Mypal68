...
class TextureSourceD3D9 {
 ...
 public:
  ...
  virtual void ReleaseTextureResources() { mTexture = nullptr; }
 ...
 protected:
  ...
  already_AddRefed<IDirect3DTexture9> InitTextures(
      DeviceManagerD3D9* aDeviceManager, const gfx::IntSize& aSize,
      _D3DFORMAT aFormat, RefPtr<IDirect3DSurface9>& aSurface,
      D3DLOCKED_RECT& aLockedRect);

  already_AddRefed<IDirect3DTexture9> DataToTexture(
      DeviceManagerD3D9* aDeviceManager, unsigned char* aData, int aStride,
      const gfx::IntSize& aSize, _D3DFORMAT aFormat, uint32_t aBPP);
  ...
  already_AddRefed<IDirect3DTexture9> TextureToTexture(
      ...
      const gfx::IntSize& aSize, _D3DFORMAT aFormat);
...
class DataTextureSourceD3D9 : public DataTextureSource,
 ...
 public:
  ...
  DataTextureSourceD3D9(IDirect3DDevice9* aDevice, gfx::SurfaceFormat aFormat,
  ...
  DataTextureSourceD3D9(IDirect3DDevice9* aDevice, gfx::SurfaceFormat aFormat,
                        gfx::IntSize aSize, IDirect3DTexture9* aTexture,
                        TextureFlags aFlags = TextureFlags::DEFAULT);

  DataTextureSourceD3D9(gfx::SurfaceFormat aFormat, gfx::IntSize aSize,
   ...
   */
  bool UpdateFromTexture(IDirect3DTexture9* aTexture,
...
class D3D9TextureData : public TextureData {
 public:
  ...
  static D3D9TextureData* Create(gfx::IntSize aSize, gfx::SurfaceFormat aFormat,
...
class DXGIYCbCrTextureHostD3D9 : public TextureHost {
 public:
  ...
  gfx::YUVColorSpace GetYUVColorSpace() const {
...
class CompositingRenderTargetD3D9 : public CompositingRenderTarget,
 ...
 public:
  CompositingRenderTargetD3D9(IDirect3DTexture9* aTexture,
                              SurfaceInitMode aInit, const gfx::IntRect& aRect);
  ...
  virtual const char* Name() const override {
    return "CompositingRenderTargetD3D9";
  }

  virtual TextureSourceD3D9* AsSourceD3D9() override {
    MOZ_ASSERT(mTexture,
               "No texture, can't be indirectly rendered. Is this "
               "the screen backbuffer?");
    return this;
  }
