...
nsresult HttpTransactionChild::InitInternal(
    ...
    uint64_t channelId, bool aHasTransactionObserver,
  ...
  nsresult rv = mTransaction->Init(
      ...
      this, topLevelOuterContentWindowId, rc, classOfService, initialRwin,
...
mozilla::ipc::IPCResult HttpTransactionChild::RecvInit(
  ...
  nsresult rv = InitInternal(
      ...
      aReqBodyIncludesHeaders, aTopLevelOuterContentWindowId, aRequestContextID,
      aClassOfService, aInitialRwin, aResponseTimeoutEnabled, aChannelId,
      aHasTransactionObserver, aPushedStreamArg);
  if (NS_FAILED(rv)) {
