...
//
// And so forth.
#define DefineCallFunction(aABI, aReturnType, aFormals, aFormalTypes,  \
                           aActuals)                                   \
...
#define DefineAllCallFunctions(aABI)                                         \
  ...
  DefineCallFunction(aABI, ReturnType, (void* aFn), (),                      \
                     ()) template <typename ReturnType, typename T0>         \
  DefineCallFunction(                                                        \
      aABI, ReturnType, (void* aFn, T0 a0), (T0),                            \
      (a0)) template <typename ReturnType, typename T0, typename T1>         \
  DefineCallFunction(aABI, ReturnType, (void* aFn, T0 a0, T1 a1), (T0, T1),  \
                     (a0, a1)) template <typename ReturnType, typename T0,   \
                                         typename T1, typename T2>           \
  DefineCallFunction(                                                        \
      aABI, ReturnType, (void* aFn, T0 a0, T1 a1, T2 a2), (T0, T1, T2),      \
      (a0, a1, a2)) template <typename ReturnType, typename T0, typename T1, \
                              typename T2, typename T3>                      \
  DefineCallFunction(                                                        \
      aABI, ReturnType, (void* aFn, T0 a0, T1 a1, T2 a2, T3 a3),             \
      (T0, T1, T2, T3),                                                      \
      (a0, a1, a2,                                                           \
       a3)) template <typename ReturnType, typename T0, typename T1,         \
                      typename T2, typename T3, typename T4>                 \
  DefineCallFunction(                                                        \
      aABI, ReturnType, (void* aFn, T0 a0, T1 a1, T2 a2, T3 a3, T4 a4),      \
      (T0, T1, T2, T3, T4),                                                  \
      (a0, a1, a2, a3,                                                       \
       a4)) template <typename ReturnType, typename T0, typename T1,         \
  ...
  DefineCallFunction(aABI, ReturnType,                                       \
                     ...
                     (T0, T1, T2, T3, T4, T5),                               \
                     (a0, a1, a2, a3, a4,                                    \
                      a5)) template <typename ReturnType, typename T0,       \
                                     typename T1, typename T2, typename T3,  \
                                     typename T4, typename T5, typename T6>  \
  DefineCallFunction(                                                        \
      aABI, ReturnType,                                                      \
      (void* aFn, T0 a0, T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, T6 a6),          \
      (T0, T1, T2, T3, T4, T5, T6),                                          \
      (a0, a1, a2, a3, a4, a5,                                               \
       a6)) template <typename ReturnType, typename T0, typename T1,         \
                      typename T2, typename T3, typename T4, typename T5,    \
                      typename T6, typename T7>                              \
  DefineCallFunction(                                                        \
      aABI, ReturnType,                                                      \
      (void* aFn, T0 a0, T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, T6 a6, T7 a7),   \
      (T0, T1, T2, T3, T4, T5, T6, T7),                                      \
      (a0, a1, a2, a3, a4, a5, a6,                                           \
       a7)) template <typename ReturnType, typename T0, typename T1,         \
                      typename T2, typename T3, typename T4, typename T5,    \
  ...
  DefineCallFunction(                                                        \
      ...
      (a0, a1, a2, a3, a4, a5, a6, a7,                                       \
       a8)) template <typename ReturnType, typename T0, typename T1,         \
                      typename T2, typename T3, typename T4, typename T5,    \
  ...
  DefineCallFunction(                                                        \
      ...
      (a0, a1, a2, a3, a4, a5, a6, a7, a8,                                   \
       a9)) template <typename ReturnType, typename T0, typename T1,         \
                      typename T2, typename T3, typename T4, typename T5,    \
                      typename T6, typename T7, typename T8, typename T9,    \
                      typename T10>                                          \
  DefineCallFunction(                                                        \
      ...
      (a0, a1, a2, a3, a4, a5, a6, a7, a8, a9,                               \
       a10)) template <typename ReturnType, typename T0, typename T1,        \
                       typename T2, typename T3, typename T4, typename T5,   \
                       typename T6, typename T7, typename T8, typename T9,   \
