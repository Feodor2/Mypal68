...
nsFilePicker::nsFilePicker() : mSelectedType(1), mDlgWnd(nullptr) {}
  ...
  switch (msg) {
    ...
    case WM_INITDIALOG: {
      ...
      if (picker) {
        ...
        SetTimer(hwnd, kDialogTimerID, 300, nullptr);
      }
    } break;
    case WM_TIMER: {
      ...
      if (wParam == kDialogTimerID) {
        ...
        if (picker && picker->ClosePickerIfNeeded()) {
